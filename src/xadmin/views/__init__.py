...
from .edit import CreateAdminView, UpdateAdminView, ModelFormAdminView, DuplicateCreateCustomView, AdsCusEditView, \
    AdsCreateAdminView, AdsABEditView, AdsABCreateAdminView
...
__all__ = (
    ...
    'ModelFormAdminView', 'CreateAdminView', 'DuplicateCreateCustomView', 'UpdateAdminView', 'DeleteAdminView',
    'DetailAdminView', 'FormAdminView',
...
def register_builtin_views(site):
    ...
    site.register_modelview(r'^(.+)/duplicate-add/$', DuplicateCreateCustomView, name='%s_%s_duplicate-add/')
    site.register_modelview(r'^(.+)/ads-edit/$', AdsCusEditView, name='%s_%s_ads-edit/')
    site.register_modelview(r'^add/ads-add/$', AdsCreateAdminView, name='%s_%s_ads-add/')

    site.register_modelview(r'^(.+)/abads-edit/$', AdsABEditView, name='%s_%s_abads-edit/')
    site.register_modelview(r'^(.+)/abads-add/$', AdsABCreateAdminView, name='%s_%s_abads-add/')
