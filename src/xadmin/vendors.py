...
vendors = {
    ...
    "select": {
        ...
        "js": {
            'dev': ["xadmin/vendor/ads/ads_cus.js",'xadmin/vendor/selectize/selectize.js', 'xadmin/vendor/select2/select2.js', 'xadmin/vendor/select2/select2_locale_%(lang)s.js'],
            'production': ["xadmin/vendor/ads/ads_cus.js",'xadmin/vendor/selectize/selectize.min.js', 'xadmin/vendor/select2/select2.min.js', 'xadmin/vendor/select2/select2_locale_%(lang)s.js']
        }
    },
    "multiselect": {
        "css": {
